<div class="form-section">
    ...
    <form method="POST">
        <div class="row mb-3">
            <div class="col-md-6">
                <label for="animeTitle" class="form-label"><i class="zmdi zmdi-slideshow"></i>Anime
                    Title</label>
                <input type="text" class="form-control" name="title" id="animeTitle" value="<?= (isset($_POST['title']))?$_POST['title']:''?>" placeholder="Enter anime title">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="saidBy" id="saidBy" value="<?= (isset($_POST['saidBy']))?$_POST['saidBy']:''?>" placeholder="Who said it?">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="quote" value="<?= (isset($_POST['quote']))?$_POST['quote']:''?>" name="quote" rows="3" placeholder="Enter the quote"></textarea>
