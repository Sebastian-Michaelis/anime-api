  ...
  <div class="container">
    ...
    <div class="form-section">
      ...
      <form>
        <div class="row mb-3">
          <div class="col-md-6">
            <label for="animeTitle" class="form-label"><i class="zmdi zmdi-slideshow"></i>Anime Title</label>
        ...
        <button type="submit" class="btn btn-primary w-100"><i class="zmdi zmdi-plus-circle"></i> Submit Quote</button>
      </form>
    </div>
